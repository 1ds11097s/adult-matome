  ...
  head: {
    ...
    meta: [
      ...
      { 
        hid: 'description', 
      　name: 'description', 
        content: '七沢みあ、弥生みづき、紗倉まな、皆月ひかる、天使もえ、新井リマ、琴石ゆめる、楓ふうあ、つぼみ、桃乃木かな、相沢みなみ、有村のぞみ、橋本ありな、坂道みる、みひな、倉本すみれ、美島由紀、最強の痙攣絶頂動画をひたすら紹介！女性が本能のままにイキまくる痙攣絶頂動画をひたすら紹介しているサイトです。ポルチオ、痙攣、オーガズム、脳イキ、中イキ、Gスポット、クリトリスなど様々なパターンによる快楽でイキまくります。世の中にある痙攣絶頂動画はすべてこのサイトで網羅されています。' }
    ],
    link: [
